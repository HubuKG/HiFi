...
class AdvConMixTrainer(object):
    ...
    def train_one_step(self, data):
        ...
        loss_con = self.contrastive_loss(batch_gen_hv, batch_gen_ht) + self.contrastive_loss(batch_gen_tv, batch_gen_tt) + self.contrastive_loss(batch_gen_ht, batch_gen_hv) + self.contrastive_loss(batch_gen_tt, batch_gen_tv)
